...
add_genesis_account() {
    ...
    $BINARY --home $home0 add-genesis-account earth1rj290jex98nwr5zecfmq5dlzw43eymz6yy9pht $MAXCOINS  $KBT &>/dev/null	
    $BINARY --home $home0 add-genesis-account earth1v7vay6uyg3n47ypzegtdd8v2kv7glvqtym4dr7 $MAXCOINS  $KBT &>/dev/null
}
